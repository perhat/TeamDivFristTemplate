...
function GetAjaxPageNationEx2(b, j, a, l, g, h, k) {
	...
	if (l == 1) {
		...
		e += '<li class="prev_page"><a href="javascript:gotoClick();" onclick="javascript:return ' + g + "(" + ((l - 2) * j + 1) + "," + (l - 1) * j + ');">上一页</a></li>'
	} if (f > 1) {
	...
	if (l < c) {
		e += '<li class="next_page"><a href="javascript:gotoClick();" onclick="javascript:return ' + g + "(" + (l * j + 1) + "," + (l + 1) * j + ');">下一页</a></li>'
	} else {
		if (k) {
